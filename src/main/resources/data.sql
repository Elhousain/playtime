...
insert into spel(naam, foto, prijs, beschrijving, min_spelers, max_spelers, min_leeftijd, taal, uitgever, status, voorraad_huur, voorraad_koop)
values ('De Kolonisten Van Catan', 'images/catan.jpg', '41.00', 'De spelers proberen elk zo lucratief mogelijk het eiland ‘Catan’ te koloniseren door er straten, dorpen en steden op te plaatsen. Wie als eerste de noodzakelijke 10 zegepunten kan verzamelen, wint.', '3', '4', '13', '1', '1', '3', '4', '10');
insert into spel(naam, foto, prijs, beschrijving, min_spelers, max_spelers, min_leeftijd, taal, uitgever, status, voorraad_huur, voorraad_koop)
values ('Clever', 'images/clever.jpg', '15.00', 'Tactisch dobbelspel voor het hele gezin. Dobbel en vul één van je geworpen dobbelstenen in de bijbehorende categorie in. Elke categorie levert op een andere manier punten op. Kies slim en let goed op de overgebleven dobbelstenen. Je moet namelijk elke dobbelsteen met een lager resultaat op het zilveren dienblad aan de andere spelers serveren. Die kunnen daardoor wellicht ook belangrijke punten scoren.', '1', '4', '5', '1', '1', '3', '2', '7');
insert into spel(naam, foto, prijs, beschrijving, min_spelers, max_spelers, min_leeftijd, taal, uitgever, status, voorraad_huur, voorraad_koop)
values ( 'Smallworld', 'images/smallworld.jpg', '45.00', 'Kies een volk en betreedt Smal World om zoveel mogelijk gebieden te veroveren. Laat dit volk na enkel ronden aan zijn lot over en kies een nieuw volk met betere mogelijkheden om zegepunten te scoren.', '2', '5', '9', '2', '2', '3', '3', '3' );
insert into spel(naam, foto, prijs, beschrijving, min_spelers, max_spelers, min_leeftijd, taal, uitgever, status, voorraad_huur, voorraad_koop)
values ( 'Monopoly', 'images/monopoly.jpg', '30.00', ' De ingrediënten om te winnen zijn natuurlijk tactiek, maar ook een beetje geluk. Het doel van het spel is om groot te worden door straten te kopen, huizen en hotels te bouwen. Heb je altijd al rijk willen worden? Het kan met Monopoly! Koop le Meir in Antwerpen of de Nieuwstraat in Brussel. Bij veel mensen zal dit spel nostalgie opwekken, maar het is ook nog steeds een fantastisch spel om voor de eerste keer te spelen. Met het vingerhoedje, de laars, de oldtimer, de kruiwagen, het schip, de hoed, het hondje en een kat als pionnen. Voor een sneller spel kan je ook de geluksdobbelsteen gebruiken, naast de normale dobbelsteen. Je hebt dan kans om de bus of MR. Monopoly te dobbelen, hiermee kan je je sneller een weg over het bord banen.', '2', '8', '8', '1', '3', '1', '0', '0' );

insert into gebruiker(voornaam, achternaam, geboortedatum, admin, email, telefoon, woonplaats, postcode, straat, huisnummer)
values ( 'Elhousain', 'Farah', '1989-04-17', 'true', 'r0797083@student.thomasmore.be', '014444444', 'Beringen', '3580', 'Hoogstraat', '32' );
insert into gebruiker(voornaam, achternaam, geboortedatum, admin, email, telefoon, woonplaats, postcode, straat, huisnummer)
values ( 'Bulent', 'Arslan', '1989-08-23', 'true', 'r0792355@student.thomasmore.be', '0433333333', 'Beringen', '3580', 'Laagstraat', '40' );
insert into gebruiker(voornaam, achternaam, geboortedatum, admin, email, telefoon, woonplaats, postcode, straat, huisnummer)
values ( 'Tom', 'Scheyltjens', '1989-03-18', 'false', 's0200162@thomasmore.student.be', '0472743607', 'Vosselaar', '2350', 'Grootheidestraat', '23' );
